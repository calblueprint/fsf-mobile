    ...
    return (
      <View style={{flex: 1, alignItems: 'center'}}>
          <Text>  
          	...
          	If you have any questions or concerns about our privacy policy or our use of data, please get in touch with us at 
          	privacy@fsf.org, +1-617-542-5942, or by our mailing address: Free Software Foundation, 51 Franklin Street, Fifth Floor, 
          	Boston, MA 02110-1335, USA. FSF staff, management, and volunteers uphold strict internal policies against unauthorized 
          	disclosure or use of personal information. We will never share your information with parties outside the FSF, unless we 
          	have explicitly made you aware that we will before you give it to us. We use services for payment processing, which 
          	requires sharing the transaction information with them over a secure connection, under legal agreement that appropriately 
          	ntrols its use and retention. We may establish similar arrangements with other formally contracted service providers, 
          	but always use privacy and security as key criteria when selecting them, and only share the data required for the service 
          	to function. As an organization with an ideological commitment to self-hosting nearly everything, the number of such 
          	providers is and will be very small.
